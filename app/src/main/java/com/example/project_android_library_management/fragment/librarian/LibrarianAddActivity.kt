...
class LibrarianAddActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        edtLibrarianId.setText(librarianDao.generateNewId())
    ...
    private fun addNewLibrarian() {
        val librarianId = edtLibrarianId.text.toString()
        ...
        if (validateFields()) {
            ...
            if (rowsAffected > 0) {
                ...
                val intent = Intent(this, LibrarianDetailActivity::class.java)
                intent.putExtra("LIBRARIAN_ID", librarianId)
                startActivity(intent)
                finish()
            } else {
                Toast.makeText(this, "Thêm thủ thư mới thất bại", Toast.LENGTH_SHORT).show()
            }
        }
    }
